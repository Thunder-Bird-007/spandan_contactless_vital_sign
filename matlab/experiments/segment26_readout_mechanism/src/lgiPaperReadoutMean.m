function hrBpm = lgiPaperReadoutMean(sig, fs, bandHz)
% LGIPAPERREADOUTMEAN [Segment 26 variant of lgiPaperReadout.m: per-window peaks aggregated by MEAN instead of median; ONE-LINE change, everything else identical] The HR read-out Pilz et al. (CVPR-W 2018, Sec. 4 Experiments) ACTUALLY used to benchmark
